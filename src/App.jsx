...
(() => {
  const checkAndCleanUrl = () => {
    ...
    if (hasProblematicUrl) {
      console.log('🚨 INTERCEPTAÇÃO APP.JS: URL problemática detectada ANTES do Router');
      ...
      try {
        ...
        if (savedData && savedStep) {
          ...
          console.log('💾 Backup Router criado antes do redirecionamento');
        }
      } catch (error) {
      ...
      console.log('🔄 Redirecionando ANTES do Router processar...');
