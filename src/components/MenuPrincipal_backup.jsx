...
const MenuPrincip    {
    ...
    },
    {
      ...
      icone: '📋',
      rota: '/relatorio',
      cor: '#9C27B0',nst navigate = useNavigate();
  ...
  const [componentes] = useState([
    ...
    },
    {
      id: 'anamnese',
      titulo: 'Anamnese',
      descricao: 'Informações sobre sintomas e histórico',
      icone: '📋',
      rota: '/anamnese',
      cor: '#2196F3',
      permissoes: ['usuario', 'medico', 'admin'],
    ...
    },
    {
      id: 'ia_analise',
      titulo: 'Análise IA',
      descricao: 'Análise inteligente dos dados',
      icone: '🤖',
      rota: '/ia-analise',
      cor: '#FF9800',
      permissoes: ['usuario', 'medico', 'admin'],
    ...
    },
    {
      id: 'relatorio',
      titulo: 'Relatório Médico',
      descricao: 'Relatório detalhado gerado',
      icone: '📊',
      rota: '/relatorio',
      cor: '#9C27B0',
      permissoes: ['usuario', 'medico', 'admin'],
    ...
    },
    {
      ...
      descricao: 'Sugestões de médicos especialistas',
      icone: '👨‍⚕️',
      rota: '/medico',
      cor: '#F44336',
      permissoes: ['usuario', 'medico', 'admin'],
    ...
    },
    {
      id: 'historico',
      titulo: 'Histórico',
      descricao: 'Histórico de consultas e exames',
      icone: '📈',
      rota: '/historico',
      cor: '#607D8B',
      permissoes: ['usuario', 'medico', 'admin'],
